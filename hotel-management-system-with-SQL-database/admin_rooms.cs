                    ...
                    using (SqlConnection connect = new SqlConnection(conn))
                    {
                        ...
                        using (SqlCommand checkRID = new SqlCommand(checkRoomID, connect))
                        {
                            ...
                            else
                            {
                                ...
                                string path = Path.Combine(@"C:\Users\gelic\OneDrive\Documents\Windows Application\hotel-management-system-with-SQL-database\hotel-management-system-with-SQL-database\room_directory\"
